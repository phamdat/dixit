...
public class EasyTouchTrigger : MonoBehaviour {
	...
	public enum ETTParameter{ None,Gesture, Finger_Id,Touch_Count, Start_Position, Position, Delta_Position, Swipe_Type, Swipe_Length, Swipe_Vector,Delta_Pinch, Twist_Anlge, ActionTime, DeltaTime, PickedObject }
				...
				if ((receiver.restricted && gesture.pickedObject == gameObject) 
					...
					switch (receiver.parameter){
						...
						case ETTParameter.PickedObject:
							sender.SendMessage( receiver.methodName,gesture.pickedCamera,SendMessageOptions.DontRequireReceiver);
							break;
